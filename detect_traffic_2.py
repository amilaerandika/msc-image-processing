...
# Total vehicle count across all frames
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if cls_id in vehicle_classes:
                ...
                total_vehicle_count += 1  # accumulate total
    ...
    print(f"Vehicles this frame: {frame_vehicle_count}")
...
print(f"\nTotal vehicles detected in the video: {total_vehicle_count}")
